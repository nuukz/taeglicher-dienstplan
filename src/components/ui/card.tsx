...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "group/card flex flex-col gap-4 overflow-hidden rounded-xl bg-card py-4 text-sm text-card-foreground ring-1 ring-foreground/10 data-[size=sm]:gap-3 data-[size=sm]:py-3 [&>img:first-child]:rounded-t-xl [&>img:last-child]:rounded-b-xl",
        className
      )}
      {...props}
    />
